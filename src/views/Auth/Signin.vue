                ...
                <div class="space-y-5">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      :class="[
                        'dark:bg-dark-900 h-11 w-full rounded-lg border px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:outline-hidden focus:ring-3',
                  ...
                  <!-- Error message -->
                  <div v-if="error" class="text-error-500 text-sm mt-1">{{ error }}</div>
        ...
        <div class="lg:w-1/2 w-full h-full bg-brand-950 dark:bg-white/5 lg:grid items-center hidden relative">
          <div class="items-center justify-center flex z-1">
            ...
            <div class="flex flex-col items-center max-w-xs">
              <img class="mb-4" width="231" height="48" src="/logo-dark-new.svg" alt="Logo" />
              <p class="text-center text-gray-400 dark:text-white/60">Work Tools of Truong Yen Vy</p>
              <p class="text-center text-gray-400 dark:text-white/60">Developed by Truong Nguyen Khanh</p>
            </div>
          </div>
        </div>
      </div>
